...
```
git clone https://gitflic.ru/project/id538390506/android-school-eltex-git.git
cd android-school-eltex-git
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/id538390506/android-school-eltex-git.git
git clone
